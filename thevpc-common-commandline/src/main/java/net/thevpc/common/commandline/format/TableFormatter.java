...
public class TableFormatter {
    ...
    public static TableFormatterBorders FANCY_ROWS_BORDER = new TableFormatterBorders(
            "", "", "", "",
            "", " ", "",
            "", "-", "-", "",
            "", "", "", ""
    );
    public static TableFormatterBorders SPACE_BORDER = new TableFormatterBorders(
            "", "", "", "",
            "", " ", "",
            "", "", "", "",
            "", "", "", ""
    ...
    private CellFormatter defaultFormatter;
    /**
     * ABBBBCBBBBD
     * E    F    G
     * HIIIIJIIIIK
     ...
     * LMMMMNMMMMO
     */
    private TableFormatterBorders border = SPACE_BORDER;
...
//    }
    ...
    public TableFormatter setVisibleHeader(boolean visibleHeader) {
        this.visibleHeader = visibleHeader;
        return this;
    }

    public TableFormatter setColumnsConfig(String... names) {
    ...
    public TableFormatter setColumnConfigIndex(String name, int index) {
        this.columns.put(name, index);
        return this;
    }

    public TableFormatterBorders getBorder() {
        return border;
    }

    public TableFormatter setBorder(TableFormatterBorders border) {
        this.border = border;
        return this;
    }
    ...
    private static class RenderedCell {
        ...
        public RenderedCell(String str, CellFormatter formatter) {
...
//                }
    ...
    public TableFormatter setVisibleColumn(int col, boolean visible) {
        if (col >= 0) {
    ...
    public TableFormatter unsetVisibleColumn(int col) {
    ...
    public TableFormatter newRow() {
        rows.add(new Row());
        return this;
    }

    public TableFormatter setHeader(Object... values) {
        header.cells.clear();
        addHeaderCell(values);
        return this;
    }

    public TableFormatter addHeaderCells(Object... values) {
    ...
    public Cell addHeaderCell(Object value) {
        Cell c = new Cell();
        c.value = value;
        header.cells.add(c);
        return c;
    ...
    public TableFormatter addCells(Object... values) {
        for (Object value : values) {
            addCell(value);
        }
        return this;
