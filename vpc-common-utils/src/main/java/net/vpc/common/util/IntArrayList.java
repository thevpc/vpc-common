...
//        modCount++;
    ...
    public IntArrayList subList(int offset, int count) {
        if (offset < 0) {
            count += offset;
            offset = 0;
        }
        ...
        return new IntArrayList(this.values, offset, count);
    }
    ...
    public IntArrayList copy() {
        return new IntArrayList(Arrays.copyOf(values, values.length), size);
    }
    ...
    public LongArrayList toLongArrayList() {
        ...
        return new LongArrayList(r, r.length);
    }
