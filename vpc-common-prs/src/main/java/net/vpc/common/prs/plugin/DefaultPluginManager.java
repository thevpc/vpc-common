...
import net.vpc.common.prs.classloader.ProxyClassLoader;
import net.vpc.common.prs.factory.ExtensionDescriptor;
import net.vpc.common.prs.softreflect.SoftField;
import net.vpc.common.prs.softreflect.classloader.SoftClassLoader;
import net.vpc.common.prs.factory.ImplementationDescriptor;
import net.vpc.common.prs.factory.ImplementationFactoryDescriptor;
import net.vpc.common.prs.reflect.FieldFilter;
import net.vpc.common.prs.reflect.MethodFilter;
...
import net.vpc.common.prs.softreflect.SoftFieldImpl;
import net.vpc.common.prs.softreflect.SoftMethodImpl;
import net.vpc.common.prs.softreflect.classloader.HostToSoftClassLoader;
...
//            TLogList logList = new TLogList(getLogger(), pluginDescriptor.getLog());
    ...
    public void initializeInstance(Object instance, FieldValueProviderManager fieldValueProviderManager, String pluginId) {
        ...
        if (classCache == null) {
            ...
            ClassInfo cinfo = Reflector.getClassInfo(clazz, new FieldFilter() {
