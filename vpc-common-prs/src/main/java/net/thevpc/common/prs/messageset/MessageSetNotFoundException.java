 ...
 */
public class MessageSetNotFoundException extends NoSuchElementException {
    public MessageSetNotFoundException() {
    }

    public MessageSetNotFoundException(String message) {
        super(message);
    }
