...
import net.thevpc.common.fprint.parser.*;
import net.thevpc.common.fprint.renderer.AnsiUnixTermPrintRenderer;
import net.thevpc.common.fprint.util.FormattedPrintStreamUtils;
...
public class FormattedPrintStream extends PrintStream {
    ...
    public FormattedPrintStream setParser(FormattedPrintStreamParser parser) {
        this.parser = parser == null ? DefaultFormattedPrintStreamParser.INSTANCE : parser;
        return this;
    }
...
//    }
    ...
    public void consumeNodes(boolean greedy) {
        FDocNode n = null;
        while ((n = partialParser.consumeNode()) != null) {
            print(DefaultFormattedPrintStreamParser.convert(n));
        }
        if (greedy) {
            partialParser.forceEnding();
            while ((n = partialParser.consumeNode()) != null) {
                print(DefaultFormattedPrintStreamParser.convert(n));
            }
        }
