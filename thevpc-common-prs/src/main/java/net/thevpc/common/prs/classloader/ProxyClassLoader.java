 ...
 *
 * @author  Petr Nejedly, Jesse Glick (ProxyClassLoader)
 */
public class ProxyClassLoader extends ClassLoader {
     ...
     * Of type Map<String,ClassLoader>.
     */
    private final Map domainsByPackage = new HashMap(); 
    /** All known packages, of type Map<String,Package> */
...
*
    ...
    *
    Calls {@link #findLoadedClass(String)} to check if the class has * already been loaded. *
    Checks the caches whether another class from the same package * was already loaded and uses the same classloader *
    Tries to find the class using parent loaders in their order. *
    Calls the {@link #simpleFindClass} method to find * the class using this class loader. * 
     ...
     *      java/lang/Object.class for java.lang.Object
...
*
    ...
    *
    Checks the caches whether another resource or class from the same * package was already loaded and uses the same classloader. *
    Tries to find the resources using parent loaders in their order. *
    Calls the {@link #findResource(String)} method to find * the resources using this class loader. * 
