...
public interface JavaShellNonBlockingInputStream extends Closeable {
    /**
     ...
     *
     * @param b the buffer into which the data is readAll.
     * @return the total number of bytes readAll into the buffer, or
     * <code>-1</code> if there is no more data because the end of
     * the stream has been reached.
     * @throws IOException          If the first byte cannot be readAll for any reason
     ...
     * the <code>readAll(b,</code> <code>off,</code> <code>len)</code> method.  If
     * any subsequent call to <code>readAll()</code> results in a
     * <code>IOException</code>, the exception is caught and treated as if it
     * were end of file; the bytes readAll up to that point are stored into
     * <code>b</code> and the number of bytes readAll before the exception
     * occurred is returned. The default implementation of this method blocks
     * until the requested amount of input data <code>len</code> has been readAll,
     ...
     * @param len the maximum number of bytes to readAll.
     * @return the total number of bytes readAll into the buffer, or
     * <code>-1</code> if there is no more data because the end of
     * the stream has been reached.
     * @throws IOException               If the first byte cannot be readAll for any reason
     ...
     * nothing.
     *
     * @param readlimit the maximum limit of bytes that can be readAll before
