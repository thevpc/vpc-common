...
public class WritablePStackImpl<T> extends AbstractProperty implements WritablePStack<T> {
    private Stack<T> value = new Stack<>();
    private PStack<T> ro;

    public WritablePStackImpl(String name, PropertyType elementType) {
