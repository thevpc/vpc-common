...
public class ClassPairMap<V> {
    ...
    private final HashMap<ClassPair, V> values = new HashMap<ClassPair, V>();
    private final HashMap<ClassPair, V[]> cachedValues = new HashMap<ClassPair, V[]>();
    private final HashMap<ClassPair, ClassPair[]> cachedHierarchy = new HashMap<ClassPair, ClassPair[]>();
    ...
    public ClassPair[] evalHierarchy(ClassPair clazz) {
        Class[] first = ClassMap.findClassHierarchy(clazz.getFirst(), baseKey1Type);
        Class[] second = ClassMap.findClassHierarchy(clazz.getSecond(), baseKey2Type);
