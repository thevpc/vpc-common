...
import net.vpc.common.textsource.impl.classpath.ClassPathResourceFilterByName;
import net.vpc.common.textsource.impl.classpath.ContextClassLoaderCharSupplier;
