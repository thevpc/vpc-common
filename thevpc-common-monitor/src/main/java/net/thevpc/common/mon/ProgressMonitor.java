...
public interface ProgressMonitor extends TaskMonitor {
    ...
    ProgressMonitor stepInto(Message message);

    ProgressMonitor stepInto(String message);

    ProgressMonitor stepInto(String message, Object... msgParams);

    ProgressMonitor stepInto(int index, int max);
