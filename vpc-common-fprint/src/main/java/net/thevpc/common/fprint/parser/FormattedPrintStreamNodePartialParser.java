...
public class FormattedPrintStreamNodePartialParser {
    ...
    public static final FormattedPrintStreamNodePartialParser INSTANCE = new FormattedPrintStreamNodePartialParser();
    List<FDocNode> all = new ArrayList<FDocNode>();
    StringBuilder curr = new StringBuilder();
    Stack<ParseAction> statusStack = new Stack<>();

    public static void main(String[] args) {
        FormattedPrintStreamNodePartialParser p = new FormattedPrintStreamNodePartialParser();
        String s = "Hello **Wol**rd";
        for (char c : s.toCharArray()) {
            p.write(c);
            p.debug();
            System.out.println("-------------------------------------------------------------");
        }
        System.out.println(p.statusStack.peek());
    }
