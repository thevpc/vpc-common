 ...
 * ====================================================================
 */
package net.vpc.commons.md.doc.util;

import net.vpc.commons.md.doc.JDDocElement;
import net.vpc.commons.md.doc.JDDocElementList;
import net.vpc.commons.md.doc.JDDocElementString;
import net.vpc.commons.md.doc.JDDocElementXml;
