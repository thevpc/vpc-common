...
//        public static net.vpc.common.util.IntIteratorBySum ofDim(int a, long maxElements) {
//            return new net.vpc.common.util.IntIteratorBySum(new int[a], maxElements);
//        }
//
//        public static net.vpc.common.util.IntIteratorBySum startWith(int[] a, long maxElements) {
