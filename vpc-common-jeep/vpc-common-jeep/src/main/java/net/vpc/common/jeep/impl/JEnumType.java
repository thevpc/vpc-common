...
public class JEnumType<T extends JEnum>{

    private final String name;
    private final Class<T> associatedClass;

    public JEnumType(String name, Class<T> associatedClass) {
        this.name = name;
    ...
    public JEnumType<T> addConstIntFields(Class cls, Predicate<Field> filter) {
    ...
    public JEnum addIntField(String name, int value) {
        Constructor c;
        try {
            c = associatedClass.getDeclaredConstructor(JEnumType.class, String.class, Integer.TYPE);
