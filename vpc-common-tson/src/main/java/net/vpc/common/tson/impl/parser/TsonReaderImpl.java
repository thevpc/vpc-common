...
import net.vpc.common.tson.impl.parser.javacc.TsonStreamParserImpl;
import net.vpc.common.tson.impl.util.StringBuilderReader;
...
public class TsonReaderImpl implements TsonReader {
    ...
    private <T> T read(Class<? extends T> clazz, ITsonStreamParser source) {
        ...
        switch (clazz.getName()) {
            case "net.vpc.common.tson.TsonElement": {
                try {
                    source.parseElement();
                } catch (Exception e) {
            ...
            case "net.vpc.common.tson.TsonDocument": {
                try {
