...
public class WordEqNode extends CommandItemNode {
    ...
    public WordEqNode(WordNode word,CommandItemNode val) {
        this.word=word;
        this.val=val;
    }

    public String toDebugString() {
        return word.toString()+"="+(val==null?"":val.toString());
    }

    public String getEscapedString(JShellContext context) {
        return word.getEscapedString(context)+"="+(val==null?"":val.getEscapedString(context));
    }
