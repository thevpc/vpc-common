...
public abstract class CommandItemNode implements Node {
    ...
    public CommandItemNode() {
    }

    public String getPathString(JShellContext context){
        return context.getShell().getWordEvaluator().expandEnvVars(getEscapedString(context),true, context);
    }

    public abstract String getEscapedString(JShellContext context);
}
